        ...
        <form method="post" class="w-auto h-auto">
            <div class="">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Cadastrar Nova Senha</h1>
                </div>
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" class="btn btn-primary w-100">Definir Nova Senha</button>
                </div>
            </div>
        </form>
    </main>
